...
💻 Tech StackComponentTechnologyWorkflow Enginen8nAI / LLM ProviderOpenAI (Chat Models)Output ParsingStructured Output ParserDatabase / CRMGoogle SheetsEmail GatewayGmail IntegrationTriggersForm Submission / Webhook